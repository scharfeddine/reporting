...
@ManagedBean(name="in_roaming")
@ViewScoped
public class StaticINRoaming implements Serializable {
private static final long serialVersionUID = 8193213035488538273L;
	
	
	@EJB
	private RoamingInRemote statINLoc;
	...
	public void handlechange(AjaxBehaviorEvent event){
		...
		if(compJourOutputHeure!=null){
			...
			if(this.getChoix_periode().equals("Par Jour")){
				...
				ValueExpression valjour = createValueExpression("#{in_roaming.date_ParJourDeb}", Date.class);
				...
				ValueExpression valjourfin = createValueExpression("#{in_roaming.date_ParJourFin}", Date.class);
			...
			ValueExpression valjour = createValueExpression("#{in_roaming.date_Parheure}", Date.class);
			cld_jour.setValueExpression("value", valjour);
				...
				lstDateYears.setId("lstDateYears");
				 ValueExpression valueExp = createValueExpression("#{in_roaming.date_year_deb}", Integer.class);
				...
				lstDateYearsFin.setId("lstDateYearsFin");
				 ValueExpression valueExp1 = createValueExpression("#{in_roaming.date_year_fin}", Integer.class);
			...
			comp.getChildren().add(lstDateYearsFin);
				...
				lstDateYearsMois.setId("lstDateYearsMois");
				 ValueExpression valueExp = createValueExpression("#{in_roaming.date_year}", Integer.class);
		         UISelectItems list_items0 = new UISelectItems();
				...
				lstMois.setId("lstMois");
				 ValueExpression valueExp1 = createValueExpression("#{in_roaming.date_mois_debut}", Integer.class);
		         UISelectItems list_items = new UISelectItems();
				...
				lstMoisFin.setId("lstMoisFin");
				 ValueExpression valueExp2 = createValueExpression("#{in_roaming.date_mois_Fin}", Integer.class);
