...
public class Allreports  implements Serializable{
	...
	public void ViewRapport(Report p ) throws IOException{
		FacesContext.getCurrentInstance().getExternalContext().redirect("/TestReportingJSF/Reporting/Preview/"+ p.getId_rapport());;
