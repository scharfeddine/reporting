           	  ...
           	  columns3[0]=chd.getDaxe_x();
       			 ...
       			 if(this.getChoix_filter_date().equals("Par heure")&&chd.getDaxe_x().equals("dateAppel")){
 		 			...
 		 			lst4 =statRemote.getAllStatMsc1("to_char(Extract (year from to_date(dateAppel,'YYMMDD')),'9999')", chd.getList_axe_y(),table, chd.getOperationD(), "Group By Extract (year from to_date(dateAppel,'YYMMDD')) ", where_liste);
 			 			...
 			 			lst4 =statRemote.getAllStatMsc1("Extract (month from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperationD(), "Group By Extract (month from to_date(dateAppel,'YYMMDD')) ", where_liste);
 				 		 }
 		 			...
 		 			lst4 =statRemote.getAllStatMsc1("destination.typeDest", chd.getList_axe_y(),table,"" , "Group By destination.typeDest ", where_liste);
 				 			...
 				 			lst4 =statRemote.getAllStatMsc1("to_date(dateAppel,'YYMMDD')", chd.getList_axe_y(),table, chd.getOperationD(), "Group By to_date(dateAppel,'YYMMDD') ", where_liste);
 					 		 }else{
...
gridReport.setColumnTitleStyle(columnTitleStyle).highlightDetailEvenRows();
      ...
      for(int i = 0;i<this.getRapport().getLst_chart().size();i++){
		 ...
		 case "line":
			 ...
			 List<Object[]> lst=statRemote.getAllStatMsc1("trancheHoraire", chd.getList_axe_y(),table, chd.getOperation(), "Group By trancheHoraire ", where_liste);
			 if(this.getChoix_filter_date().equals("Par heure")&&chd.getAxe_x().equals("dateAppel")){
		 			...
		 			lst =statRemote.getAllStatMsc1("Extract (year from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperation(), "Group By Extract (year from to_date(dateAppel,'YYMMDD')) ", where_liste);
			 		 }else if(this.getChoix_filter_date().equals("Par mois")&&chd.getAxe_x().equals("dateAppel")){
			 			lst =statRemote.getAllStatMsc1("Extract (month from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperation(), "Group By Extract (month from to_date(dateAppel,'YYMMDD')) ", where_liste);
				 		 }
		 		 else if(chd.getAxe_x().equals("typeDest")){
		 			lst =statRemote.getAllStatMsc1("s.destination.typeDest", chd.getList_axe_y(),table, chd.getOperation(), "Group By s.destination.typeDest ", where_liste);
				 		 }else if(this.getChoix_filter_date().equals("Par Jour")&&chd.getAxe_x().equals("dateAppel")){
				 			lst =statRemote.getAllStatMsc1("to_date(dateAppel,'YYMMDD')", chd.getList_axe_y(),table, chd.getOperation(), "Group By to_date(dateAppel,'YYMMDD') ", where_liste);
					 		 }else{
		 ...
		 case "bar":
			 ...
			 List<Object[]> lst1=statRemote.getAllStatMsc1("Extract (year from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperation(), "Group By Extract (year from to_date(dateAppel,'YYMMDD')) ", where_liste);
			 //List<Object[]> lst=statRemote.getAllStatMsc("trancheHoraire", chd.getList_axe_y(),table, chd.getOperation(), "Group By trancheHoraire ", where_liste);
			 if(this.getChoix_filter_date().equals("Par heure")&&chd.getAxe_x().equals("dateAppel")){
		 			...
		 			lst1 =statRemote.getAllStatMsc1("Extract (year from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperation(), "Group By Extract (year from to_date(dateAppel,'YYMMDD')) ", where_liste);
			 		 }else if(this.getChoix_filter_date().equals("Par mois")&&chd.getAxe_x().equals("dateAppel")){
			 			lst1 =statRemote.getAllStatMsc1("Extract (month from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperation(), "Group By Extract (month from to_date(dateAppel,'YYMMDD')) ", where_liste);
				 		 }
		 		 else if(chd.getAxe_x().equals("typeDest")){
		 			lst1 =statRemote.getAllStatMsc1("s.destination.typeDest", chd.getList_axe_y(),table, chd.getOperation(), "Group By s.destination.typeDest ", where_liste);
				 			...
				 			lst1 =statRemote.getAllStatMsc1("Extract (day from to_date(dateAppel,'YYMMDD'))", chd.getList_axe_y(),table, chd.getOperation(), "Group By Extract (day from to_date(dateAppel,'YYMMDD')) ORDER BY Extract (day from to_date(dateAppel,'YYMMDD')) DESC ", where_liste);
					 		 }else{
		 ...
		 case "pie":
			...
			Pie3DChartBuilder pichart = cht.pie3DChart();
			 ...
			 List<Object[]> lst2=statRemote.getAllStatMsc("Extract (year from to_date(dateAppel,'YYMMDD'))", axe_y_pie,table, chd.getOperation(), "Group By Extract (year from to_date(dateAppel,'YYMMDD')) ", where_liste);
			 //List<Object[]> lst=statRemote.getAllStatMsc("trancheHoraire", chd.getList_axe_y(),table, chd.getOperation(), "Group By trancheHoraire ", where_liste);
			 if(this.getChoix_filter_date().equals("Par heure")&&chd.getAxe_x().equals("dateAppel")){
		 			lst2 =statRemote.getAllStatMsc("trancheHoraire", axe_y_pie,table, chd.getOperation(), "Group By trancheHoraire ", where_liste);
		    		
		 		 }else if(this.getChoix_filter_date().equals("Par An")&&chd.getAxe_x().equals("dateAppel")){
		 			lst2 =statRemote.getAllStatMsc("Extract (year from to_date(dateAppel,'YYMMDD'))", axe_y_pie,table, chd.getOperation(), "Group By Extract (year from to_date(dateAppel,'YYMMDD')) ", where_liste);
			 		 }else if(this.getChoix_filter_date().equals("Par mois")&&chd.getAxe_x().equals("dateAppel")){
			 			lst2 =statRemote.getAllStatMsc("Extract (month from to_date(dateAppel,'YYMMDD'))", axe_y_pie,table, chd.getOperation(), "Group By Extract (month from to_date(dateAppel,'YYMMDD')) ", where_liste);
				 		 }
		 		 else if(chd.getAxe_x().equals("typeDest")){
		 			lst2 =statRemote.getAllStatMsc("s.destination.typeDest", axe_y_pie,table, chd.getOperation(), "Group By s.destination.typeDest ", where_liste);
				 		 }else if(this.getChoix_filter_date().equals("Par Jour")&&chd.getAxe_x().equals("dateAppel")){
				 			lst2 =statRemote.getAllStatMsc("Extract (day from to_date(dateAppel,'YYMMDD'))", axe_y_pie,table, chd.getOperation(), "Group By Extract (day from to_date(dateAppel,'YYMMDD')) ORDER BY Extract (day from to_date(dateAppel,'YYMMDD')) DESC ", where_liste);
					 		 }else{
