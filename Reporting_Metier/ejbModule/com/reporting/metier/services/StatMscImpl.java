...
public class StatMscImpl implements StatMscImplRemote {
	...
	public Map<Object, Number> getConfiguartionChartByCfg(String x, String y,String table,String action ,String groupby) {
			...
			if(x.contains("dateAppel")){
				...
				Query q = em.createQuery("Select  to_date("+x+",'yyMMdd')  ,"+action+" "+y+" " +"From "+table+" "+groupby+" Order BY to_date(dateAppel,'YYMMDD') desc ");
	...
	@Override
	public Map<String, Number> getMscByFilters1(String x, String y,String table,
	...
	@Override
	public Map<Object, Number> getMscByFilters(String x, String y,String table,
			String action, String groupby, List<String> Where) {
	...
	@Override
	public Map<Object, Number> getMscBytranche(String x, String y,String table,
			String action, String groupby, List<String> Where) {
